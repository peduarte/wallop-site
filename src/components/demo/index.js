    ...
    return (
      <div className="Demo">
        <div className="Wallop">
          ...
          <div className="Wallop-item Wallop-thanks"><p>Thank you for looking & thank you <a href="https://dribbble.com/TonyBabel">TonyBabel</a> for the beautiful gifs<br/><a href="https://twitter.com/share" className="twitter-share-button" data-via="peduarte">Tweet</a></p></div>
